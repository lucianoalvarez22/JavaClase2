...
public class ServerSocketNumsNoCiclicoText {
	...
	public ServerSocketNumsNoCiclicoText(int puerto) throws IOException {
	...
	public static void main(String[] args) {
		...
		ServerSocketNumsNoCiclicoText server;
		
		//TENEMOS EL PUERTO 8081
		try {
			server = new ServerSocketNumsNoCiclicoText(8081);
			server.start();
